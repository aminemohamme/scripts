...
--(I know the movement is scuffed but expect improvements)
--REQUIRED hats/hair:
...
Frame.BackgroundColor3 = Color3.fromRGB(167, 167, 167)
Frame.BorderSizePixel = 0
Frame.Position = UDim2.new(0.317870736, 0, 0.293827176, 0)
Frame.Size = UDim2.new(0, 479, 0, 334)

title.Name = "title"
title.Parent = Frame
title.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
title.BackgroundTransparency = 1.000
title.Position = UDim2.new(0.246346563, 0, 0.0179640725, 0)
title.Size = UDim2.new(0, 242, 0, 50)
title.Font = Enum.Font.SourceSans
title.Text = "Fe spy drone V1"
...
controls.Position = UDim2.new(0.035490606, 0, 0.209580839, 0)
controls.Size = UDim2.new(0, 350, 0, 50)
controls.Font = Enum.Font.SourceSans
controls.Text = "Controls: Q,W,E,A,S,D keys"
...
Toggle.Name = "Toggle"
Toggle.Parent = Frame
Toggle.BackgroundColor3 = Color3.fromRGB(0, 255, 8)
Toggle.BorderSizePixel = 5
Toggle.Position = UDim2.new(0.707724452, 0, 0.440119773, 0)
...
First.Position = UDim2.new(0.035490606, 0, 0.407185614, 0)
First.Size = UDim2.new(0, 301, 0, 61)
First.Font = Enum.Font.SourceSans
First.Text = "first person drone POV:"
First.TextColor3 = Color3.fromRGB(0, 0, 0)
...
Start.Name = "Start"
Start.Parent = Frame
Start.BackgroundColor3 = Color3.fromRGB(255, 255, 0)
Start.BorderSizePixel = 5
Start.Position = UDim2.new(0.325678498, 0, 0.772455037, 0)
Start.Size = UDim2.new(0, 167, 0, 50)
...
Credit.Position = UDim2.new(0.0292275567, 0, 0.733532965, 0)
Credit.Size = UDim2.new(0, 125, 0, 75)
Credit.Font = Enum.Font.SourceSans
Credit.Text = "Made by rouxhaver/1+1=2"
...
border.Parent = Frame
border.Color = Color3.fromRGB(53,53,53)
border.Thickness = 6

Camera_Enabled = true

Toggle.MouseButton1Down:Connect(function()
	if Camera_Enabled == false then do
			Toggle.Text = "Y"
			Toggle.BackgroundColor3 = Color3.fromRGB(0, 255, 8)
			Camera_Enabled = true
		end else
		Toggle.BackgroundColor3 = Color3.fromRGB(255, 0, 8)
		Toggle.Text = "N"
...
while waiting == true do wait(0.1) end

function weld(Part1,Part2) 
	local join = Instance.new("WeldConstraint",Part1)
	join.Part0 = Part1
	join.Part1 = Part2
end

function weld2(Part1,Part2,Offset)
    local join = Instance.new("Weld",Part1)
	join.Part0 = Part1
	join.Part1 = Part2
    join.C0 = Offset
end

function hinge(Part1,Part2,offset)
	local hinge = Instance.new("CylindricalConstraint",Part1)
	local leatt = Instance.new("Attachment",Part1)
	local opatt = Instance.new("Attachment",Part2)
	opatt.CFrame = CFrame.new(0,-0.6,0) * CFrame.Angles(0,0,math.rad(90))
	leatt.CFrame = CFrame.new(offset) * CFrame.Angles(0,0,math.rad(90))
	hinge.Attachment0 = leatt
	hinge.Attachment1 = opatt
	hinge.LimitsEnabled = true
	hinge.UpperLimit = 0
end

function force(Part)
	local force = Instance.new("VectorForce",Part)
	local att = Instance.new("Attachment",Part)
	att.CFrame = CFrame.new(-1,0,0.5)
	force.Attachment0 = att
	force.Force = Vector3.new(propspeed,0,0)
end
...
Parts = Instance.new("Folder",workspace)
Parts.Name = "Drone Parts"

centerp = player.Character.Head.Position

drbase = Instance.new("Part",Parts)
pole1 = Instance.new("Part",Parts)
pole2 = Instance.new("Part",Parts)
pole3 = Instance.new("Part",Parts)
pole4 = Instance.new("Part",Parts)
prop1 = Instance.new("Part",Parts)
prop2 = Instance.new("Part",Parts)
prop3 = Instance.new("Part",Parts)
prop4 = Instance.new("Part",Parts)

drbase.Position = centerp
drbase.Size = Vector3.new(2,1,2)
drbase.Anchored = true
drbase.Transparency = 1

pole1.Position = centerp + Vector3.new(-1,0.5,1)
pole1.Size = Vector3.new(1,1,1)
pole1.Transparency = 1

pole2.Position = centerp + Vector3.new(1,0.5,-1)
pole2.Size = Vector3.new(1,1,1)
pole2.Transparency = 1

pole3.Position = centerp + Vector3.new(1,0.5,1)
pole3.Size = Vector3.new(1,1,1)
pole3.Transparency = 1

pole4.Position = centerp + Vector3.new(-1,0.5,-1)
pole4.Size = Vector3.new(1,1,1)
pole4.Transparency = 1

prop1.Position = centerp
prop1.Size = Vector3.new(2,1,1)
prop1.Transparency = 1

prop2.Position = centerp
prop2.Size = Vector3.new(2,1,1)
prop2.Transparency = 1

prop3.Position = centerp
prop3.Size = Vector3.new(2,1,1)
prop3.Transparency = 1

prop4.Position = centerp 
prop4.Size = Vector3.new(2,1,1)
prop4.Transparency = 1
...
hinge(pole1,prop1,Vector3.new(-0.5,0.5,0.5))
hinge(pole2,prop2,Vector3.new(0.5,0.5,-0.5))
hinge(pole3,prop3,Vector3.new(0.5,0.5,0.5))
hinge(pole4,prop4,Vector3.new(-0.5,0.5,-0.5))
...
function brick(Part)
    if char.Model[Part].Handle:FindFirstChild("Mesh") then do
        char.Model[Part].Handle.Mesh:Destroy()
    end else
        char.Model[Part].Handle.SpecialMesh:Destroy()
    end
    char.Model[Part].Name = "Breh"
    char[Part].Handle.AccessoryWeld:Destroy()
    char[Part].Name = "Breh"
end

brick("Hat1")
weld2(drbase,char.Breh.Handle,CFrame.new(-0.5,0,0))
char.Breh.Name = "sigh"
...
brick("InternationalFedora")
weld2(pole1,char.Breh.Handle,CFrame.new())
char.Breh.Name = "sigh"

brick("InternationalFedora")
weld2(pole2,char.Breh.Handle,CFrame.new())
char.Breh.Name = "sigh"

brick("International Fedora")
weld2(pole3,char.Breh.Handle,CFrame.new())
char.Breh.Name = "sigh"

brick("International Fedora")
weld2(pole4,char.Breh.Handle,CFrame.new())
char.Breh.Name = "sigh"

brick("Robloxclassicred")
weld2(prop1,char.Breh.Handle,CFrame.new())
char.Breh.Name = "sigh"

brick("Kate Hair")
weld2(prop2,char.Breh.Handle,CFrame.new())
char.Breh.Name = "sigh"

brick("LavanderHair")
weld2(prop3,char.Breh.Handle,CFrame.new())
char.Breh.Name = "sigh"

brick("Pal Hair")
weld2(prop4,char.Breh.Handle,CFrame.new())
char.Breh.Name = "sigh"
...
while wait(0.01) do
    if workspace[player.Name]:FindFirstChild("sigh") == nil then
        Parts:Destroy()
        break
    end
    
	check = 0
	if UserInputService:IsKeyDown(Enum.KeyCode.A) == true and moveB == 0 and moveF == 0 and moveR == 0 and moveU == 0 and moveD == 0 then
		moveL = 15
		check = 1
		speed = speed + 0.05
	end
	if UserInputService:IsKeyDown(Enum.KeyCode.D) == true and moveB == 0 and moveL == 0 and moveF == 0 and moveU == 0 and moveD == 0 then
		moveR = 15
		check = 1
		speed = speed + 0.05
	end
	if UserInputService:IsKeyDown(Enum.KeyCode.W) == true and moveB == 0 and moveL == 0 and moveR == 0 and moveU == 0 and moveD == 0 then
		speed = speed + 0.05
		check = 1
		moveF = 15
	end
	if UserInputService:IsKeyDown(Enum.KeyCode.S) == true and moveF == 0 and moveL == 0 and moveR == 0 and moveU == 0 and moveD == 0 then
		moveB = 15
		check = 1
		speed = speed + 0.05
	end
	if UserInputService:IsKeyDown(Enum.KeyCode.Q) == true and moveB == 0 and moveL == 0 and moveR == 0 and moveF == 0 and moveU == 0 then
		moveD = 15
		check = 1
		speed = speed + 0.05
	end
	if UserInputService:IsKeyDown(Enum.KeyCode.E) == true and moveB == 0 and moveL == 0 and moveR == 0 and moveD == 0 and moveF == 0 then
		moveU = 15
		check = 1
		speed = speed + 0.05
	end
	...
	if moveF > 0 then
		drbase.CFrame = drbase.CFrame + (drbase.CFrame.LookVector * Vector3.new(speed,0,speed))
		moveF = moveF -1
	end
	...
	if moveL > 0 then
		drbase.CFrame = drbase.CFrame * CFrame.Angles(0,math.rad(speed*6.66666667),0)
		moveL = moveL -1
	end
	...
	if moveU > 0 then
		drbase.CFrame = drbase.CFrame + Vector3.new(0,speed,0)
		moveU = moveU -1
	end
	...
	if check == 0 and speed > 0.1 then
		speed = speed - 0.05
	end
	if Camera_Enabled == true then
		cam.CFrame = drbase.CFrame
	end
end
