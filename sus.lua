--this is garbage and took me like 10 minutes to make so enjoy being sus -rouxhaver
...
--myscript
wait(5.1)
me = workspace[game.Players.LocalPlayer.Name]

weld = Instance.new("Weld",me)
weld.Part0 = me.Torso
weld.Part1 = me["Left Arm"]
weld.C0 = CFrame.new(0.3,0,0.7)
...
me.Head.att1_Head.Position = Vector3.new(0,-1.15,0)

for i,v in pairs(me:GetDescendants()) do
if v:IsA("Accessory") then
if v.Handle:FindFirstChild("att1_Handle") then do
v.Handle.att1_Handle.CFrame = CFrame.new(0, -0.9, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1)
end
else
v.Name = "stupid"
end
